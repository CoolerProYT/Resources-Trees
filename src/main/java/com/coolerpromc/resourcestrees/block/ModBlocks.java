...
public class ModBlocks {
    ...
    public static final DeferredBlock<ResourcesSaplingBlock> RESOURCES_PALE_OAK_SAPLING =
    ...
    public static final DeferredBlock<ResourcesLeavesBlock> RESOURCES_PALE_OAK_LEAVES =
    ...
    private static <T extends Block> void registerBlockItem(String name, DeferredBlock<T> block){
        ModItems.ITEMS.registerItem(name, properties -> new ModBlockItem(block.get(), properties.useBlockDescriptionPrefix()));
    }
