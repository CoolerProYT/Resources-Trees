...
public class ModBlocks {
    ...
    public static final ResourcesLeavesBlock RESOURCES_OAK_LEAVES =
            registerBlock("resources_oak_leaves", properties -> new ResourcesLeavesBlock(properties, () -> RESOURCES_OAK_SAPLING), AbstractBlock.Settings.copy(Blocks.OAK_LEAVES));
    ...
    public static final ResourcesLeavesBlock RESOURCES_SPRUCE_LEAVES =
            registerBlock("resources_spruce_leaves", properties -> new ResourcesLeavesBlock(properties, () -> RESOURCES_SPRUCE_SAPLING), AbstractBlock.Settings.copy(Blocks.SPRUCE_LEAVES));
    ...
    public static final ResourcesLeavesBlock RESOURCES_BIRCH_LEAVES =
            registerBlock("resources_birch_leaves", properties -> new ResourcesLeavesBlock(properties, () -> RESOURCES_BIRCH_SAPLING), AbstractBlock.Settings.copy(Blocks.BIRCH_LEAVES));
    ...
    public static final ResourcesLeavesBlock RESOURCES_JUNGLE_LEAVES =
            registerBlock("resources_jungle_leaves", properties -> new ResourcesLeavesBlock(properties, () -> RESOURCES_JUNGLE_SAPLING), AbstractBlock.Settings.copy(Blocks.JUNGLE_LEAVES));
    ...
    public static final ResourcesLeavesBlock RESOURCES_ACACIA_LEAVES =
            registerBlock("resources_acacia_leaves", properties -> new ResourcesLeavesBlock(properties, () -> RESOURCES_ACACIA_SAPLING), AbstractBlock.Settings.copy(Blocks.ACACIA_LEAVES));
    ...
    public static final ResourcesLeavesBlock RESOURCES_DARK_OAK_LEAVES =
            registerBlock("resources_dark_oak_leaves", properties -> new ResourcesLeavesBlock(properties, () -> RESOURCES_DARK_OAK_SAPLING), AbstractBlock.Settings.copy(Blocks.DARK_OAK_LEAVES));
    ...
    public static final ResourcesLeavesBlock RESOURCES_CHERRY_LEAVES =
            registerBlock("resources_cherry_leaves", properties -> new ResourcesLeavesBlock(properties, () -> RESOURCES_CHERRY_SAPLING), AbstractBlock.Settings.copy(Blocks.CHERRY_LEAVES));
    ...
    private static <T extends Block> void registerBlockItem(String name, T block){
        ModItems.registerItem(name, properties -> new ModBlockItem(block, properties));
    }
