...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<StrictShapedRecipe>> STRICT_SHAPED = registerSerializer("strict_shaped", StrictShapedRecipe.Serializer.INSTANCE);
