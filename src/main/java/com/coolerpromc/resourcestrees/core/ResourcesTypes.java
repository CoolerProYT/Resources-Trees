...
public record ResourcesTypes(Either<Identifier, TagKey<Item>> material, int color, String translationKey, int weight, float saplingChance, float secondaryDropChance){
    ...
    public static void bootstrap(Registerable<ResourcesTypes> context){
        ...
        context.register(FIRE, new ResourcesTypes(ModItems.FIRE_ESSENCE, 0xFFE45323 , "item.resourcestrees.fire", 5, 0.25f, 0.5f));
        context.register(NETHER, new ResourcesTypes(Items.NETHERRACK, 0xFF511515 , "item.resourcestrees.nether", 5, 0.25f, 0.5f));
        context.register(END, new ResourcesTypes(ModItems.END_ESSENCE, 0xFFC5BE8B , "item.resourcestrees.end", 5, 0.25f, 0.5f));
        context.register(NATURE, new ResourcesTypes(ModItems.NATURE_ESSENCE, 0xFF1a6e08 , "item.resourcestrees.nature", 5, 0.25f, 0.5f));
        context.register(WATER, new ResourcesTypes(ModItems.WATER_ESSENCE, 0xFF1787D4, "item.resourcestrees.water", 5, 0.25f, 0.5f));
