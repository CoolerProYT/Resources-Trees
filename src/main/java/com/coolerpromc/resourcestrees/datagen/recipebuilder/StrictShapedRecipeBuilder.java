...
public class StrictShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public StrictShapedRecipeBuilder(RecipeCategory category, ItemLike result, int count) {
    ...
    public StrictShapedRecipeBuilder unlockedBy(String p_126133_, CriterionTriggerInstance p_126134_) {
