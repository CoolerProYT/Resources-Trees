...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        lineShape(Items.TURTLE_SCUTE, 8, ResourcesTypes.TURTLE, output);
        ...
        straightShape(Items.BREEZE_ROD, 8, ResourcesTypes.BREEZE, output);
        ...
        essenceItem(ModItems.END_ESSENCE.get(), output, Items.END_STONE, Items.CHORUS_FRUIT, Items.CHORUS_FLOWER, Items.PURPUR_BLOCK);
        ...
        essenceItem(ModItems.TURTLE_ESSENCE.get(), output, Items.TURTLE_EGG, Items.TURTLE_EGG, Items.TURTLE_EGG, Items.TURTLE_SCUTE, Items.TURTLE_SCUTE, Items.TURTLE_SCUTE);
        essenceItem(ModItems.BLAZE_ESSENCE.get(), output, Items.BLAZE_ROD, Items.BLAZE_ROD, Items.BLAZE_ROD, Items.BLAZE_ROD);
        essenceItem(ModItems.BREEZE_ESSENCE.get(), output, Items.BREEZE_ROD, Items.BREEZE_ROD, Items.BREEZE_ROD, Items.BREEZE_ROD);
    ...
    private void essenceItem(ItemLike ouputItem, RecipeOutput output, Item... inputItems){
    ...
    private void straightShape(Item outputItem, int count, ResourceKey<ResourcesTypes> resourceType, RecipeOutput output){
        StrictShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, outputItem, count)
                .pattern(" A ")
                .pattern(" A ")
                .pattern(" A ")
