...
public class ModBlocks {
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_OAK_SAPLING =
            registerBlock("resources_oak_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.OAK, properties, Constants.id("resources_oak_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING));
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_SPRUCE_SAPLING =
            registerBlock("resources_spruce_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.SPRUCE, properties, Constants.id("resources_spruce_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.SPRUCE_SAPLING));
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_BIRCH_SAPLING =
            registerBlock("resources_birch_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.BIRCH, properties, Constants.id("resources_birch_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.BIRCH_SAPLING));
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_JUNGLE_SAPLING =
            registerBlock("resources_jungle_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.JUNGLE, properties, Constants.id("resources_jungle_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.JUNGLE_SAPLING));
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_ACACIA_SAPLING =
            registerBlock("resources_acacia_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.ACACIA, properties, Constants.id("resources_acacia_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_SAPLING));
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_DARK_OAK_SAPLING =
            registerBlock("resources_dark_oak_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.DARK_OAK, properties, Constants.id("resources_dark_oak_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.DARK_OAK_SAPLING));
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_CHERRY_SAPLING =
            registerBlock("resources_cherry_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.CHERRY, properties, Constants.id("resources_cherry_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_SAPLING));
    ...
    public static final BlockRegistryHandler<ResourcesSaplingBlock> RESOURCES_PALE_OAK_SAPLING =
            registerBlock("resources_pale_oak_sapling", properties -> new ResourcesSaplingBlock(TreeGrower.PALE_OAK, properties, Constants.id("resources_pale_oak_leaves")), BlockBehaviour.Properties.ofFullCopy(Blocks.PALE_OAK_SAPLING));
