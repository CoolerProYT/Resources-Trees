...
public class ModBlocks {
    ...
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_OAK_SAPLING =
            registerSaplingBlock("resources_oak_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_OAK_LEAVES =
            registerLeavesBlock("resources_oak_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).noLootTable());

    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_SPRUCE_SAPLING =
            registerSaplingBlock("resources_spruce_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.SPRUCE_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_SPRUCE_LEAVES =
            registerLeavesBlock("resources_spruce_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.SPRUCE_LEAVES).noLootTable());

    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_BIRCH_SAPLING =
            registerSaplingBlock("resources_birch_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.BIRCH_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_BIRCH_LEAVES =
            registerLeavesBlock("resources_birch_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.BIRCH_LEAVES).noLootTable());

    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_JUNGLE_SAPLING =
            registerSaplingBlock("resources_jungle_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.JUNGLE_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_JUNGLE_LEAVES =
            registerLeavesBlock("resources_jungle_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.JUNGLE_LEAVES).noLootTable());

    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_ACACIA_SAPLING =
            registerSaplingBlock("resources_acacia_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_ACACIA_LEAVES =
            registerLeavesBlock("resources_acacia_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_LEAVES).noLootTable());

    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_DARK_OAK_SAPLING =
            registerSaplingBlock("resources_dark_oak_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.DARK_OAK_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_DARK_OAK_LEAVES =
            registerLeavesBlock("resources_dark_oak_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.DARK_OAK_LEAVES).noLootTable());

    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_CHERRY_SAPLING =
            registerSaplingBlock("resources_cherry_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_CHERRY_LEAVES =
            registerLeavesBlock("resources_cherry_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_LEAVES).noLootTable());

    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesSaplingBlock> RESOURCES_PALE_OAK_SAPLING =
            registerSaplingBlock("resources_pale_oak_sapling", LegacyResourcesSaplingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.PALE_OAK_SAPLING).noLootTable());
    @Deprecated(forRemoval = true)
    public static final BlockRegistryHandler<LegacyResourcesLeavesBlock> RESOURCES_PALE_OAK_LEAVES =
            registerLeavesBlock("resources_pale_oak_leaves", LegacyResourcesLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.PALE_OAK_LEAVES).noLootTable());
