...
public class ModRecipes {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<TreeSimulatorRecipe>> TREE_SIMULATOR_SERIALIZER = registerSerializer("tree_simulator", TreeSimulatorRecipe.SERIALIZER);

    public static final Supplier<RecipeSerializer<StrictShapedRecipe>> STRICT_SHAPED = registerSerializer("strict_shaped", StrictShapedRecipe.SERIALIZER);
