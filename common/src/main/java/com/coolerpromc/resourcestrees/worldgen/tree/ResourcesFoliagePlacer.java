...
public class ResourcesFoliagePlacer extends FoliagePlacer {
    ...
    @Override
    public void createFoliage(WorldGenLevel reader, FoliageSetter setter, RandomSource random, TreeConfiguration config, int trunkHeight, FoliageAttachment attachment, int foliageHeight, int radius, int offset) {
